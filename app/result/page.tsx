  ...
  const results = [
    {
      ...
      imageWidth: "w-[420px]",
      description: "你是一個重感情的人。比起刺激，你更在意誰陪你走過。你常懷念過去，因為那些時光很珍貴。",
    ...
    },
    {
      ...
      imageWidth: "w-[420px]",
      description: "你是很有故事的人。很多情緒你不一定會說，但會默默記很久。你不常沉溺在過去，只是有些瞬間，你認為值得反覆回味。",
    ...
    },
    {
      ...
      imageWidth: "w-[300px]",
      description: "你有細膩而穩定的靈魂。喜歡安靜，也需要屬於自己的空間。比起被外界帶著走，你更習慣用自己的節奏整理情緒。",
